...
- Нет **Telnet** и raw TCP — только SSH и Serial/COM.
...
Дорожная карта: надёжность → Telnet и raw TCP → multi-host и automation. RDP/VNC пока вне планов. Подробнее — [release notes 1.2.2](docs/RELEASE_NOTES_v1.2.2.md).
