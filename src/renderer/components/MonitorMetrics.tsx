...
export function MonitorMetrics({ sessionId, compact }: { sessionId: string; compact?: boolean }): JSX.Element {
  ...
  return (
    <div className={'ws-metrics' + (compact ? ' compact' : '')}>
      <div className="ws-metrics-head">
        <span className="ws-metrics-title">
          <Icon name="monitor" size={14} /> Ресурсы
        </span>
        {m && (
